...
MinMaxHeap = function (comparator, options) {                                         // 13
  ...
  self._minHeap = new MaxHeap(function (a, b) {                                       // 17
    return -comparator(a, b);                                                         // 18
  }, options);                                                                        // 19
};                                                                                    // 20
                                                                                      // 21
Meteor._inherits(MinMaxHeap, MaxHeap);                                                // 22
                                                                                      // 23
_.extend(MinMaxHeap.prototype, {                                                      // 24
  set: function (id, value) {                                                         // 25
    var self = this;                                                                  // 26
    MaxHeap.prototype.set.apply(self, arguments);                                     // 27
    self._minHeap.set(id, value);                                                     // 28
  },                                                                                  // 29
  remove: function (id) {                                                             // 30
    var self = this;                                                                  // 31
    MaxHeap.prototype.remove.apply(self, arguments);                                  // 32
    self._minHeap.remove(id);                                                         // 33
  },                                                                                  // 34
  clear: function () {                                                                // 35
    var self = this;                                                                  // 36
    MaxHeap.prototype.clear.apply(self, arguments);                                   // 37
    self._minHeap.clear();                                                            // 38
  },                                                                                  // 39
  setDefault: function (id, def) {                                                    // 40
    var self = this;                                                                  // 41
    MaxHeap.prototype.setDefault.apply(self, arguments);                              // 42
    return self._minHeap.setDefault(id, def);                                         // 43
  },                                                                                  // 44
  clone: function () {                                                                // 45
    var self = this;                                                                  // 46
    var clone = new MinMaxHeap(self._comparator, self._heap);                         // 47
    return clone;                                                                     // 48
  },                                                                                  // 49
  minElementId: function () {                                                         // 50
    var self = this;                                                                  // 51
    return self._minHeap.maxElementId();                                              // 52
  }                                                                                   // 53
});                                                                                   // 54
                                                                                      // 55
                                                                                      // 56
